...
import { ChevronRight, Clock, XCircle, Settings, Lock, Handshake } from "lucide-react";
import { SubHeader } from "../components/Header";
import { leagueDetailData, initialsFor } from "../lib/mockData";
  ...
  return (
    <>
      <div className="flex items-center justify-between px-4 pt-4 pb-3">
        ...
        <button onClick={() => setLocation(`/leagues/${params?.id}/manage-admins`)}>
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar pb-2">
          ...
          <div className="mt-4">
            <div className="flex justify-between items-center px-4 mb-2">
              ...
              <button onClick={() => setLocation(`/leagues/${params?.id}/survivors`)} className="text-[11px] text-emerald-400 flex items-center gap-0.5">
            ...
            <div className="flex gap-3 px-4 overflow-x-auto no-scrollbar">
              {d.survivors.map((s) => (
                <button
                  key={s.id}
                  onClick={() => setLocation(`/leagues/${params?.id}/opponent/${s.id}`)}
